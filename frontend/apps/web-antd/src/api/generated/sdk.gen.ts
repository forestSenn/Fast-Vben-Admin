 ...
 */
export const tenantsSyncAllTenantPlanMenus = <ThrowOnError extends boolean = false>(options?: Options<TenantsSyncAllTenantPlanMenusData, ThrowOnError>): RequestResult<TenantsSyncAllTenantPlanMenusResponses, unknown, ThrowOnError> => (options?.client ?? client).post<TenantsSyncAllTenantPlanMenusResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
